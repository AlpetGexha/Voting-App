<form wire:submit.prevent='create()' method="POST" class="space-y-4 px-4 py-6">
    {{-- <x-honeypot /> --}}
    <div>
        <x-input wire:model.defer='title'
            class="w-full text-sm text-gray-900 bg-gray-100 border-none rounded-xl placeholder-gray-900 px-4 py-2"
    ...
    <div>
        <x-textarea wire:model.defer='body' name="idea" id="idea" cols="30" rows="4"
